...
export const PointOfInterestMarker = memo(({ pointOfInterestType, useSmallMarker }: Props) => {
  switch (pointOfInterestType) {
    case POIType.LevelCrossing:
      return <LevelCrossing width={useSmallMarker ? 36 : 58} height={useSmallMarker ? 36 : 58} />;
    case POIType.LesserLevelCrossing:
      return (
        <LesserLevelCrossing width={useSmallMarker ? 32 : 46} height={useSmallMarker ? 28 : 40} />
      );
    case POIType.Picnic:
      return <Picnic width={useSmallMarker ? 32 : 48} height={useSmallMarker ? 32 : 48} />;
    case POIType.TrackEnd:
      return <TrackEnd width={useSmallMarker ? 32 : 48} height={useSmallMarker ? 32 : 48} />;
    case POIType.TurningPoint:
      return <TurningPoint width={useSmallMarker ? 32 : 48} height={useSmallMarker ? 32 : 48} />;
    default:
      return <View />;
  }
});
