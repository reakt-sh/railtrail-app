const translations = {
  en: {
    ...
    navigationMap: 'Map',
    navigationInfo: 'Info',
    landingPageWelcome: 'Welcome to RailTrail',
  ...
  de: {
    ...
    navigationMap: 'Karte',
    navigationInfo: 'Info',
    landingPageWelcome: 'Willkommen bei RailTrail',
    landingPageDescription:
    ...
    trackSelectionDescription: 'Wähle die Strecke aus, die Sie bereisen möchten.',
